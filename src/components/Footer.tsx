    ...
    <footer className="w-full border-t-2 border-black bg-zinc-50 text-black">
      <div className="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          {/* SECTION 2: CONTACT */}
          <div className="space-y-4">
            <h3 className="text-[12px] font-black uppercase tracking-[0.3em] text-black">Contact Us</h3>
            <div className="space-y-3">
              <div className="space-y-1">
                ...
                >
                  <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-500 group-hover:text-black transition-colors">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="ml-7 flex items-center gap-1.5 text-[11px] font-black uppercase tracking-widest text-zinc-700 hover:text-black underline underline-offset-4 transition-colors"
                >
              ...
              <div className="flex flex-col gap-1.5">
                <a href="tel:7874568421" className="flex items-center gap-3 group w-fit">
                  ...
                  <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-500 group-hover:text-black transition-colors">7874568421</span>
                </a>
                <a href="tel:9978605512" className="flex items-center gap-3 group w-fit ml-7">
                  <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-500 group-hover:text-black transition-colors">9978605512</span>
                </a>
              </div>
              <a href="mailto:tokyofashion320124@gmail.com" className="flex items-center gap-3 group w-fit">
                ...
                <span className="text-[11px] font-bold tracking-wider text-zinc-500 group-hover:text-black transition-colors lowercase">tokyofashion320124@gmail.com</span>
              </a>
            </div>
          </div>
          ...
          {/* SECTION 3: SOCIALS */}
          <div className="space-y-4">
            <h3 className="text-[12px] font-black uppercase tracking-[0.3em] text-black">Follow Us</h3>
            <div className="flex flex-col gap-3">
              {socialIcons.map((social) => (
                ...
                >
                  {social.icon}
                  <span className="text-[12px] font-black uppercase tracking-[0.2em] text-black ml-1">Follow on Instagram</span>
                </a>
              ))}
            </div>
          </div>
        ...
        <div className="mt-8 border-t border-zinc-100 pt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            <p className="text-[11px] font-bold text-zinc-400 text-center sm:text-left uppercase tracking-widest">
              &copy; {new Date().getFullYear()} TOKYO FASHION. ALL RIGHTS RESERVED.
            </p>
            <p className="text-[11px] font-black uppercase tracking-[0.2em] text-zinc-400 text-center sm:text-left">
          ...
          <div className="flex justify-center gap-6 text-[11px] font-bold text-zinc-400 uppercase tracking-widest">

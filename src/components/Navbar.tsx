...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="w-full max-w-[1440px] mx-auto flex items-center justify-between px-4 md:px-12 py-1.5 md:py-2 transition-[padding] duration-300"
        >
          {/* ── Hamburger ── */}
          <button
            onClick={() => setIsSidebarOpen(true)}
            style={iconBtn(true)}
            className="w-8 h-8 md:w-9 md:h-9 flex items-center justify-center rounded-full transition-all duration-300 hover:opacity-80 active:scale-95"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              style={iconBtn(false)}
              className="flex w-8 h-8 md:w-9 md:h-9 items-center justify-center rounded-full transition-all duration-300 hover:opacity-80"
              aria-label="Search"
            >
            ...
            <button
              ...
              style={iconBtn(false)}
              className="relative w-8 h-8 md:w-9 md:h-9 flex items-center justify-center rounded-full transition-all duration-300 hover:opacity-80 active:scale-95"
              aria-label="Wishlist"
            >

    ...
    <div className="flex flex-col w-full min-h-screen bg-white">
      ...
      <section className="w-full bg-[#111] text-white py-24 md:py-36 relative overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl md:text-6xl font-black tracking-widest uppercase mb-4 font-serif">ABOUT TOKYO FASHION</h1>
      ...
      <section className="w-full max-w-4xl mx-auto py-12 md:py-24 px-6 text-center md:text-center text-zinc-600 space-y-6 md:space-y-8 text-sm md:text-base leading-relaxed">
        <p>
          Welcome to <span className="font-black text-black">Tokyo Fashion</span> – your trusted online clothing brand where fashion meets comfort, quality, and style. We believe that clothes are more than just outfits – they are an expression of personality, confidence, and individuality.
        </p>
        <p>
          At Tokyo Fashion, we design and deliver premium-quality clothing for men and women, including casual wear, streetwear, trendy outfits, and everyday essentials. Every piece is crafted from high-quality fabrics with a perfect balance of comfort and modern style, ensuring you look good and feel great all day.
        </p>
        <p>
          Whether you&apos;re searching for stylish t-shirts, classic shirts, trendy dresses, chic tops, or everyday essentials, Tokyo Fashion brings you affordable fashion without compromising on quality.
        </p>
        <p>
          Our mission is simple – to make fashion accessible, stylish, and reliable for everyone. With Tokyo Fashion, you don&apos;t just wear clothes; <span className="font-black text-black">you wear confidence</span>.
        </p>
      </section>
      ...
      <section className="w-full px-4 md:px-6 pb-24 md:pb-36 flex justify-center">
        <div className="w-full max-w-6xl bg-[#0a0a0a] text-white rounded-[2rem] md:rounded-[3rem] p-10 md:p-24 text-center flex flex-col items-center shadow-2xl relative overflow-hidden">
           ...
           <p className="text-sm md:text-xl text-gray-400 mb-10 max-w-2xl relative z-10 font-medium leading-relaxed">
             Experience the perfect blend of style, comfort, and quality. Start your fashion journey with Tokyo Fashion today.
           </p>

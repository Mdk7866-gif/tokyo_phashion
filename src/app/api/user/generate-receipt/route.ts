        ...
        <body>
          ...
          <div class="details-grid">
            <div>
              ...
              <strong>Order ID:</strong> ${(order.id || 'N/A').toLowerCase()}<br>
              <strong>Payment ID:</strong> ${(payment?.razorpay_payment_id || 'N/A').toLowerCase()}<br>
              <strong>Method:</strong> ${order.payment_method.toUpperCase()}<br>
              <strong>Date:</strong> ${new Date(order.created_at || Date.now()).toLocaleDateString()}
            </div>
            <div>
              <div class="section-title">Customer Details</div>
              <strong>Name:</strong> ${profile?.name || 'N/A'}<br>
              <strong>Email:</strong> ${(profile?.email || 'N/A').toLowerCase()}<br>
              <strong>Mobile:</strong> ${profile?.mobile_number || 'N/A'}<br>
